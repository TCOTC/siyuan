        ...
        searchConfig.element.querySelectorAll("input").forEach((item) => {
            item.addEventListener("change", () => {
                fetchPost("/api/setting/setSearch", {
                    ...
                    listItem: (searchConfig.element.querySelector("#listItem") as HTMLInputElement).checked,
                    codeBlock: (searchConfig.element.querySelector("#codeBlock") as HTMLInputElement).checked,
                    htmlBlock: (searchConfig.element.querySelector("#htmlBlock") as HTMLInputElement).checked,
                    embedBlock: (searchConfig.element.querySelector("#embedBlock") as HTMLInputElement).checked,
                    databaseBlock: (searchConfig.element.querySelector("#databaseBlock") as HTMLInputElement).checked,
                    audioBlock: (searchConfig.element.querySelector("#audioBlock") as HTMLInputElement).checked,
                    videoBlock: (searchConfig.element.querySelector("#videoBlock") as HTMLInputElement).checked,
                    iframeBlock: (searchConfig.element.querySelector("#iframeBlock") as HTMLInputElement).checked,
                    widgetBlock: (searchConfig.element.querySelector("#widgetBlock") as HTMLInputElement).checked,
                    mathBlock: (searchConfig.element.querySelector("#mathBlock") as HTMLInputElement).checked,
                    table: (searchConfig.element.querySelector("#table") as HTMLInputElement).checked,
                    blockquote: (searchConfig.element.querySelector("#blockquote") as HTMLInputElement).checked,
                    callout: (searchConfig.element.querySelector("#callout") as HTMLInputElement).checked,
                    superBlock: (searchConfig.element.querySelector("#superBlock") as HTMLInputElement).checked,
                    paragraph: (searchConfig.element.querySelector("#paragraph") as HTMLInputElement).checked,
                    name: (searchConfig.element.querySelector("#name") as HTMLInputElement).checked,
                    alias: (searchConfig.element.querySelector("#alias") as HTMLInputElement).checked,
                    memo: (searchConfig.element.querySelector("#memo") as HTMLInputElement).checked,
                    ial: (searchConfig.element.querySelector("#ial") as HTMLInputElement).checked,
                    indexAssetPath: (searchConfig.element.querySelector("#indexAssetPath") as HTMLInputElement).checked,
                    limit: parseInt((searchConfig.element.querySelector("#limit") as HTMLInputElement).value),
                    caseSensitive: (searchConfig.element.querySelector("#caseSensitive") as HTMLInputElement).checked,
                    backlinkMentionName: (searchConfig.element.querySelector("#backlinkMentionName") as HTMLInputElement).checked,
                    backlinkMentionAlias: (searchConfig.element.querySelector("#backlinkMentionAlias") as HTMLInputElement).checked,
                    backlinkMentionAnchor: (searchConfig.element.querySelector("#backlinkMentionAnchor") as HTMLInputElement).checked,
                    backlinkMentionDoc: (searchConfig.element.querySelector("#backlinkMentionDoc") as HTMLInputElement).checked,
                    backlinkMentionKeywordsLimit: parseInt((searchConfig.element.querySelector("#backlinkMentionKeywordsLimit") as HTMLInputElement).value),
                    virtualRefName: (searchConfig.element.querySelector("#virtualRefName") as HTMLInputElement).checked,
                    virtualRefAlias: (searchConfig.element.querySelector("#virtualRefAlias") as HTMLInputElement).checked,
                    virtualRefAnchor: (searchConfig.element.querySelector("#virtualRefAnchor") as HTMLInputElement).checked,
                    virtualRefDoc: (searchConfig.element.querySelector("#virtualRefDoc") as HTMLInputElement).checked,
                }, response => {
